...
│   └── Dockerfile
├── outputs/                 # Models, predictions (generated by run_all.py)
└── requirements.txt
```
...
![Small Object Problem](outputs/small_object_problem.png)
*Why small object detection is hard — tiny vehicles in a massive satellite scene*

![YOLOv8x Baseline](outputs/predictions/yolov8_baseline.png)
*YOLOv8x baseline detection on sample image*

![YOLOv8x + SAHI Comparison](outputs/predictions/sahi_comparison.png)
*Side-by-side: baseline vs SAHI — notice how SAHI finds more detections*

![Results Summary](outputs/results_summary.png)
*Performance comparison: baseline YOLO vs YOLO+SAHI across object sizes*
